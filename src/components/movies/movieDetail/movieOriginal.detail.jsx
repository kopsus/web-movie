...
const MovieOriginalDetail = ({ detailMovie, closeModal }) => {
      ...
      <div className="parent-movie-detail">
        <div className="contain-movie-detail">
          ...
          <div className="release-popular-vote">
            <p>Tanggal Rilis: {detailMovie.release_date}</p>
            <p>Populeritas: {detailMovie.popularity}</p>
...
export default MovieOriginalDetail
